...
RUN mkdir ${HOME}/upo-fcn-learning

COPY . ${HOME}/upo-fcn-learning

#################################### CATKIN ####################################

RUN mkdir -p ${HOME}/catkin_ws/src && ln -s ${HOME}/upo-fcn-learning ${HOME}/catkin_ws/src/.
